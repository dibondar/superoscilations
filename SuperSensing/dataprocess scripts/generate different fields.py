# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 10:07:41 2023
...
for i in range(0,len(freqs)):
    ...
    Et2_ty.append(np.real(bf.array_ifftx(time, lga_trans(freq, Ef, omega0=1.2, gamma=0.5*1e12))))
    Et2_tx.append(np.zeros(len(Et2_ty[i])))
    Et2s_ty.append(np.real(bf.array_ifftx(time, lga_trans(freq, Ef, omega0=1.2, gamma=0.5*1e12)))[idx1:idx2])
